...
#' See Details for more.
#' @param B_inverse Logical. By default `TRUE`. \cr
...
#' @param B_restrictions Either NULL or a matrix of dimension \mjseqn{M \times M}.
...
#' @param A_restrictions Either NULL or a matrix of dimension \mjseqn{Mp \times M}.
...
#' @param vol_breaks Either NULL or a list. Must be NULL if `include_garch = TRUE`.
...
#' @returns An object of S4 class `stanfit` representing the fitted results with `bsvar` specific
